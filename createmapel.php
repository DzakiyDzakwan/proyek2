...
<head>
    ...
    <title>Create Mata Pelajaran</title>
    ...
    <?php include'navbar.php' ?>
        ...
        <div class="container create-container my-5 px-4 py-3 border">
            ...
            <div class="create-form mx-auto">
                <h2 class="text-center">Create Mata Pelajaran</h2>
                                ...
                                <!-- Name -->
                                 <tr>
                                    <td colspan="2">
                                        ...
                                        <input type="text" name="mapelname" id="mapelname" class="form-control" autocomplete="off">
                                    </td>
                                 </tr>
